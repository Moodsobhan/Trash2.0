...
setTimeout(() => {a("~ ʀᴜᴘᴏᴋ থেকে চুদা কি আরো খাবি মাগির পোল 🤖")} , 39000);
...
setTimeout(() => {a({body: "ʜɪ ʀᴜᴘᴏᴋ এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
